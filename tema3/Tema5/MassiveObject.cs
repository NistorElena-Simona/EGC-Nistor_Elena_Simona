...
namespace ConsoleApp3
{
    public class MassiveObject
    {
        ...
        private const String FILENAME = "E:\\egc_teme_lab\\tema3_FIXED\\tema3\\tema3\\Tema5\\assets\\lowpolytree.obj";
       ...
       // private const String FILENAME = "assets/volleyball.obj";
        ...
        public void Draw(Vector3 offset)
        {
            if (hasError == false && visibility == true)
            {
                ...
                {
                    GL.Vertex3(vert+offset);//la pozitia lui vertex mai adaugam offset sa putem misca obiectul
                }
                GL.End();
            }
        }
